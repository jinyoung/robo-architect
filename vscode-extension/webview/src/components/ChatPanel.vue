        ...
        >
          ...
          <template v-else-if="message.type === 'assistant'">
            ...
            <div v-if="message.changes && message.changes.length > 0" class="chat-changes">
              ...
              <div 
                v-for="(change, idx) in message.changes" 
                :key="idx"
                class="chat-change-item"
              >
...
.chat-change-item__action--create {
  background: rgba(52, 211, 153, 0.2);
  color: #34d399;
}

.chat-change-item__action--update {
  background: rgba(96, 165, 250, 0.2);
  color: #60a5fa;
}

.chat-change-item__action--rename {
  background: rgba(251, 191, 36, 0.2);
  color: #fbbf24;
}

.chat-change-item__action--delete {
  background: rgba(239, 68, 68, 0.2);
  color: #ef4444;
}

.chat-change-item__action--connect {
  background: rgba(167, 139, 250, 0.2);
  color: #a78bfa;
}

.chat-change-item__target {
  color: var(--color-text);
}
