...
async function checkExistingData() {
  ...
  try {
    const response = await fetch(`${apiBase()}/api/graph/stats`)
    if (response.ok) {
...
async function checkCacheStatus() {
  try {
    const response = await fetch(`${apiBase()}/api/ingest/cache/status`)
    if (response.ok) {
...
async function toggleCache() {
  ...
  try {
    ...
    const response = await fetch(`${apiBase()}/api/ingest/cache/${endpoint}`, {
      method: 'POST'
    })
...
async function clearExistingData() {
  ...
  try {
    const response = await fetch(`${apiBase()}/api/graph/clear`, { method: 'DELETE' })
    if (response.ok) {
...
async function startIngestion() {
  ...
  try {
    ...
    const uploadResponse = await fetch(`${apiBase()}/api/ingest/upload`, {
      method: 'POST',
      body: formData
    })
...
async function checkAndRestoreSession() {
  ...
  try {
    ...
    const response = await fetch(`${apiBase()}/api/ingest/session/${savedSession.sessionId}/status`)
    if (!response.ok) {
      clearSessionFromStorage()
      return
    }
...
async function togglePause() {
  ...
  try {
    ...
    const response = await fetch(`${apiBase()}/api/ingest/${sessionId.value}/${endpoint}`, {
      method: 'POST'
    })
