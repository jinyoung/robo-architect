...
export const useChangeStore = defineStore('change', () => {
  ...
  async function analyzeImpact(userStoryId, editedData) {
    ...
    try {
      ...
      const impactResponse = await fetch(`${getBaseUrl()}/api/change/impact/${userStoryId}`)
      ...
      const planResponse = await fetch(`${getBaseUrl()}/api/change/plan`, {
        method: 'POST',
  ...
  async function revisePlan(userStoryId, feedback) {
    ...
    try {
      const response = await fetch(`${getBaseUrl()}/api/change/plan`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          userStoryId,
  ...
  async function applyChanges(userStoryId) {
    ...
    try {
      const response = await fetch(`${getBaseUrl()}/api/change/apply`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          userStoryId,
